...
export default function ContactIcons() {
  return (
    <div className="flex justify-center space-x-6 mt-4">
      ...
      <Link
        href="mailto:jibraniqbal.shah@mail.utoronto.ca" // CHANGE: Replace with your email
      ...
      <Link
        href="https://www.linkedin.com/in/jibran-iqbal-shah/" // CHANGE: Replace with your LinkedIn URL
        target="_blank"
        rel="noopener noreferrer"
        className="text-gray-300 hover:text-white transition-colors duration-200"
        aria-label="LinkedIn"
